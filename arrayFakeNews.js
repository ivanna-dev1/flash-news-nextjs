export const news = [
  {
    ...
    subcategory: "climate",
    article: `
Імператорських пінгвінів внесено до списку видів, які перебувають під загрозою зникнення.

Міжнародна організація з охорони зникаючих видів дикої природи внесла імператорського пінгвіна до списку видів, що зникають.

Зміна статусу цього виду свідчить про екзистенційну загрозу для видів, які залежать від льоду, оскільки глобальне потепління докорінно змінює облік Антарктиди.

Імператорські пінгвіни залежать від морського льоду для життя, полювання та розмноження. Раніше руйнування та зникнення цих льодових платформ призвело до різкого скорочення їх чисельності.

Міжнародний союз охорони природи (IUCN) повідомив, що зміна морського льоду, викликана зміною клімату, ймовірно призведе до скорочення популяції імператорських пінгвінів удвічі до 2080-х років.

Вчені дійшли висновку, що викликана діяльністю людини зміна клімату є найбільш серйозною загрозою для цього виду.

Червоний список IUCN є найбільш повним джерелом інформації про стан видів у світі.

Імператорські пінгвіни — найбільші представники свого виду — стали символом виживання у суворому кліматі Антарктиди.

Вони розмножуються на морському льоду взимку, а самці зігрівають яйця, тримаючи їх на лапах. Лід також необхідний для вирощування пташенят.

Однак через зміну клімату морський лід стає нестабільним і руйнується раніше.

З 2016 року рівень морського льоду досяг рекордно низьких показників. За даними супутникових спостережень, у період з 2009 до 2018 року зникло близько 20 000 дорослих особин — приблизно 10% популяції.

Вчені зазначають, що імператорські пінгвіни є видом-індикатором, який показує масштаб змін клімату.

Також повідомляється про ризик масової загибелі птахів під час періоду линяння, коли вони особливо залежать від стабільного льоду.
`
  },
  // GENERAL
  {
  ...
  {
    id: 12,
    title: "Daily habits that improve long-term health",
    description:
  ...
  {
    id: 15,
    title: "Tennis star claims major title",
    description:
  ...
  {
    id: 18,
    title: "Popular series renewed for another season",
    description:
